...
import com.dailycodebuffer.OrderService.command.api.command.CreateOrderCommond;
...
public class OrderAggregate {
    ...
    @CommandHandler
    public OrderAggregate(CreateOrderCommond createOrderCommond) {

        OrderCreatedEvent orderCreatedEvent = new OrderCreatedEvent();

        BeanUtils.copyProperties(createOrderCommond,orderCreatedEvent);
