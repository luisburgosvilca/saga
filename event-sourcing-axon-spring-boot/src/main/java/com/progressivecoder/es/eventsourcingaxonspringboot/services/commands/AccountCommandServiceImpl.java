...
public class AccountCommandServiceImpl implements AccountCommandService {
    ...
    @Override
    public CompletableFuture<CreateAccountCommand> createAccount(AccountCreateDTO accountCreateDTO) {
    	CreateAccountCommand createAccountCommand = new CreateAccountCommand(UUID.randomUUID().toString(), accountCreateDTO.getStartingBalance(),
    ...
    public CompletableFuture<String> debitMoneyFromAccount(String accountNumber, MoneyDebitDTO moneyDebitDTO) {
        return commandGateway.send(new DebitMoneyCommand(accountNumber, moneyDebitDTO.getDebitAmount(), 
